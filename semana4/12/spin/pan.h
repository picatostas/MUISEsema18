...
#define _nstates3	59	/* spec */
#define minseq3	160
#define maxseq3	217
#define _endstate3	58

#define _nstates2	13	/* entorno */
#define minseq2	148
#define maxseq2	159
#define _endstate2	12

#define _nstates1	75	/* secundario_fsm */
#define minseq1	74
#define maxseq1	147
#define _endstate1	74

#define _nstates0	75	/* principal_fsm */
#define minseq0	0
#define maxseq0	73
...
#define Pentorno	((P2 *)this)
typedef struct P2 { /* entorno */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define Psecundario_fsm	((P1 *)this)
typedef struct P1 { /* secundario_fsm */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define Pprincipal_fsm	((P0 *)this)
typedef struct P0 { /* principal_fsm */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct State {
	...
	unsigned timerP : 1;
	unsigned timerS : 1;
	uchar principal_state;
	uchar secundario_state;
#ifdef TRIX
...
#define HAS_TRACK	0
/* hidden variable: */	uchar Vp;
/* hidden variable: */	uchar Ap;
/* hidden variable: */	uchar Rp;
/* hidden variable: */	uchar Vs;
/* hidden variable: */	uchar As;
/* hidden variable: */	uchar Rs;
