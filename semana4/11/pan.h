...
#define _nstates4	28	/* spec */
#define minseq4	78
#define maxseq4	104
#define _endstate4	27

#define _nstates3	17	/* enviroment */
#define minseq3	62
#define maxseq3	77
#define _endstate3	16

#define _nstates2	18	/* lights_fsm */
#define minseq2	45
#define maxseq2	61
#define _endstate2	17

#define _nstates1	14	/* code_fsm */
#define minseq1	32
#define maxseq1	44
#define _endstate1	13

#define _nstates0	33	/* alm_fsm */
#define minseq0	0
#define maxseq0	31
...
#define Penviroment	((P3 *)this)
typedef struct P3 { /* enviroment */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Plights_fsm	((P2 *)this)
typedef struct P2 { /* lights_fsm */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Pcode_fsm	((P1 *)this)
typedef struct P1 { /* code_fsm */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Palm_fsm	((P0 *)this)
typedef struct P0 { /* alm_fsm */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#endif
	unsigned bt_user : 1;
	unsigned pir_sensor : 1;
	unsigned code_ok : 1;
	unsigned p1 : 1;
	unsigned p2 : 1;
	unsigned lights_timer : 1;
	uchar alm_state;
	uchar light_state;
	uchar code_state;
#ifdef TRIX
...
#define HAS_TRACK	0
/* hidden variable: */	uchar bt_timer_finished;
/* hidden variable: */	uchar alm_led;
/* hidden variable: */	uchar buzzer;
/* hidden variable: */	uchar lights_led;
/* hidden variable: */	uchar intrussion;
