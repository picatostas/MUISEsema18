...
#define pthread_equal(a,b)	((a)==(b))
	...
	case 8: // STATE 27 - _spin_nvr.tmp:19 - [-end-] (0:0:0 - 1)
		...
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC lights_fsm */
	case 9: // STATE 1 - alarma.pml:46 - [light_state = off] (0:0:1 - 1)
		IfNotBlocked
		reached[2][1] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 10: // STATE 2 - alarma.pml:48 - [((light_state==off))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][2] = 1;
		if (!((((int)now.light_state)==1)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 11: // STATE 3 - alarma.pml:50 - [((p1||p2))] (14:0:1 - 1)
		IfNotBlocked
		reached[2][3] = 1;
		...
		;
		_m = 3; goto P999; /* 3 */
	case 12: // STATE 8 - alarma.pml:53 - [((light_state==on))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][8] = 1;
		if (!((((int)now.light_state)==2)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 13: // STATE 9 - alarma.pml:55 - [(((p1||p2)||lights_timer))] (14:0:1 - 1)
		IfNotBlocked
		reached[2][9] = 1;
		...
		;
		_m = 3; goto P999; /* 3 */
	case 14: // STATE 17 - alarma.pml:59 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[2][17] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC code_fsm */
	case 15: // STATE 1 - alarma.pml:35 - [code_state = parser] (0:0:1 - 1)
		IfNotBlocked
		reached[1][1] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 16: // STATE 2 - alarma.pml:37 - [((code_state==parser))] (0:0:0 - 1)
		IfNotBlocked
		reached[1][2] = 1;
		if (!((((int)now.code_state)==6)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 17: // STATE 3 - alarma.pml:39 - [(bt_user)] (10:0:1 - 1)
		IfNotBlocked
		reached[1][3] = 1;
		if (!(((int)now.bt_user)))
			continue;
		...
		;
		_m = 3; goto P999; /* 3 */
	case 18: // STATE 8 - alarma.pml:42 - [.(goto)] (0:10:0 - 2)
		IfNotBlocked
		reached[1][8] = 1;
		;
		/* merge: .(goto)(0, 11, 10) */
		...
		;
		_m = 3; goto P999; /* 1 */
	case 19: // STATE 5 - alarma.pml:40 - [(!(bt_user))] (10:0:1 - 1)
		IfNotBlocked
		reached[1][5] = 1;
		if (!( !(((int)now.bt_user))))
			continue;
		...
		;
		_m = 3; goto P999; /* 3 */
	case 20: // STATE 13 - alarma.pml:44 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[1][13] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC alm_fsm */
	case 21: // STATE 1 - alarma.pml:13 - [alm_state = disarmed] (0:0:1 - 1)
		IfNotBlocked
		reached[0][1] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 22: // STATE 2 - alarma.pml:15 - [((alm_state==disarmed))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][2] = 1;
		if (!((((int)now.alm_state)==5)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 23: // STATE 3 - alarma.pml:17 - [(code_ok)] (29:0:3 - 1)
		IfNotBlocked
		reached[0][3] = 1;
		if (!(((int)now.code_ok)))
			continue;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 24: // STATE 10 - alarma.pml:20 - [((alm_state==armed))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][10] = 1;
		if (!((((int)now.alm_state)==4)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 25: // STATE 11 - alarma.pml:22 - [(code_ok)] (29:0:3 - 1)
		IfNotBlocked
		reached[0][11] = 1;
		if (!(((int)now.code_ok)))
			continue;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 26: // STATE 19 - alarma.pml:25 - [.(goto)] (0:29:0 - 2)
		IfNotBlocked
		reached[0][19] = 1;
		;
		/* merge: .(goto)(0, 30, 29) */
		...
		;
		_m = 3; goto P999; /* 1 */
	case 27: // STATE 15 - alarma.pml:23 - [(pir_sensor)] (29:0:2 - 1)
		IfNotBlocked
		reached[0][15] = 1;
		...
		;
		_m = 3; goto P999; /* 4 */
	case 28: // STATE 21 - alarma.pml:26 - [((alm_state==intrusion))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][21] = 1;
		if (!((((int)now.alm_state)==3)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 29: // STATE 22 - alarma.pml:28 - [(code_ok)] (29:0:3 - 1)
		IfNotBlocked
		reached[0][22] = 1;
		if (!(((int)now.code_ok)))
			continue;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 30: // STATE 32 - alarma.pml:33 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[0][32] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
